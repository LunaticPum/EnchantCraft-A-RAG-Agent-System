    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-[420px] glass p-10" style={{ animation: "fade-in 300ms ease-out" }}>
        <div className="flex flex-col items-center gap-3 mb-8">
          ...
          <p className="text-xs text-[var(--color-ink-faint)]">演示版 · 输入任意用户名密码即可</p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <button onClick={handleLogin} disabled={loading} className="pill pill--dark w-full justify-center py-3 text-sm shadow-lg mt-4">
